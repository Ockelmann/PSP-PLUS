...
function mostrarDatos(datos){
    datos.forEach(usuario =>{
        ...
        inputConfirmarClave.value = usuario.clave;
...
function validar(){
    ...
    if(inputNombre.value == ""||inputApellido.value == ""|| inputEmail.value == ""|| inputClave.value == ""|| inputFecha.value == "" || inputEquipo.value == 0 || inputConfirmarClave.value == "" ){
