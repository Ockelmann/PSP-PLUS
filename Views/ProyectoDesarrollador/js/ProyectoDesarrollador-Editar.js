...
async function getProyecto() {
    const url = `${URL_Global}/EditarProyecto?IdProyecto=${idProyecto}`;
...
async function editProyecto() {
    const url = `${URL_Global}/ProyectoDesarrollador?idproyecto=${idProyecto}&nombre=${inputNombre.value}&descripcion=${inputDescripcion.value}&cliente=${inputCliente.value}&fechainicioesperada=${inputFechaInicioEsperada.value}&fechafinalesperada=${inputFechaFinalEsperada.value}&dev=${inputDev.value}`;
