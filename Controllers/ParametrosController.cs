...
namespace PSP_.Controllers
{
    ...
    {
        static readonly string desKey = "m/ti5TXBWPOigPCSqBy0Kg==";
        ...
        [HttpPut]
        public ActionResult Put([FromBody] Models.Parametro modelo)
        {
            using (Models.DBPSPPLUSContext db = new Models.DBPSPPLUSContext())
            {
                Models.Parametro datos = db.Parametros.Find(1);

                datos.Inactividad = modelo.Inactividad;
                datos.Correo = modelo.Correo;
